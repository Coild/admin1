...
class pjt extends Controller
{
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',1)->where('user_id', $id);
        // dd($protap);
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',2)->where('user_id', $id);;
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',3)->where('user_id', $id);;
        $data = spesifikasi::all()->where('pabrik_id', $id)
            ->where('kategori', 3);
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',4)->where('user_id', $id);;
        $data = spesifikasi::all()->where('pabrik_id', $id)
            ->where('kategori', 4);
