...
class pjt extends Controller
{
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',1)->where('protap_pabrik', $id);
        // dd($protap);
        $data = spesifikasi::all()->where('pabrik_id', $id)->where('kategori', 1);
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',2)->where('protap_pabrik', $id);;
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',3)->where('protap_pabrik', $id);;
        $data = spesifikasi::all()->where('pabrik_id', $id)
            ->where('kategori', 3);
    ...
    {
        $id = Auth::user()->pabrik;
        $protap = protap::all()->where('protap_jenis',3)->where('protap_detil',4)->where('protap_pabrik', $id);;
        $data = spesifikasi::all()->where('pabrik_id', $id)
            ->where('kategori', 4);
