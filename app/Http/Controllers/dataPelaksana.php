        ...
        return DataTables::of($data)->editColumn('status', function ($data) {
            ...
            if (Auth::user()->level != 2) {
                if ($data->status == 0) {
                    ...
                    </form>' . '<button type="button" id="editbahan" class="btn btn-primary" data-toggle="modal" data-target="#modaleditbahan"
                ...
                if ($data->status == 0) {
                    return '<form method="post" class="float-left mr-1" action="detilterimabb">
                        ...
                        <input type="hidden" name="induk"
                            ...
                            value=' . 0 . ' />
                        <button type="submit" class="btn btn-success">Lihat</button>
                    </form>' . '<button type="button" id="editproduk" class="btn btn-primary" data-toggle="modal" data-target="#modaleditproduk"
                ...
                if ($data->status == 0) {
                    return '<form method="post" class="float-left mr-1" action="detilterimabb">
                        ...
                        <input type="hidden" name="induk"
                            ...
                            value=' . 0 . ' />
                        <button type="submit" class="btn btn-success">Lihat</button>
                    </form>' . '<button type="button" id="editkemasan" class="btn btn-primary" data-toggle="modal" data-target="#modaleditkemasan"
