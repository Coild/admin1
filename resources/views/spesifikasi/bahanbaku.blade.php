@extends('layout.app')
@section('title')
<title>Spesifikasi Bahan Baku</title>
@endsection

@section('content')
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4"> Spesifikasi Bahan Baku </h1>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form action="/tambah_bahan_baku" method="post" enctype="multipart/form-data" role="form" id="forminput1">

                                        @csrf
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                        <div class="form-group">
                                            <label for="inputName">Sesuai PROTAP</label>
                                            <select class="form-control 1" name="protap" id="protap">
                    ...
                    <table class="table" id="tabelbeda1">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/hapusBB" method="post" id="hapusBB{{$row['spesifikasi_id']}}">
                                        @csrf
                                    ...
                                    <a href="/asset/coa/{{$row['file']}}" type="button" class="btn btn-primary">Buka</button>
                                </td>
                            </tr>
