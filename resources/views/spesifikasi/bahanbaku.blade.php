                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form action="/tambah_bahan_baku" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/hapus_bahan_baku/{{$row['spesifikasi_id']}}" type="button" class="btn btn-danger" onclick="return confirm('Hapus ? ')">Hapus</a>
