                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form action="/tambah_produk_jadi" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <table class="table" id="tabel1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/hapus_produk_jadi/{{$row['spesifikasi_id']}}" type="button" class="btn btn-danger" onclick="return confirm('Hapus ? ')">Hapus</a>
