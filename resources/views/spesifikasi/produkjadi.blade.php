@extends('layout.app')
@section('title')
<title>Spesifikasi Produk Jadi</title>
@endsection

@section('content')
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4"> Spesifikasi Produk Jadi </h1>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form action="/tambah_produk_jadi" method="post" enctype="multipart/form-data" role="form" id="forminput1">
                    ...
                    <table class="table" id="tabel1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/hapus_produk_jadi" method="post" id="hapusBB{{$row['spesifikasi_id']}}">
                                        @csrf
