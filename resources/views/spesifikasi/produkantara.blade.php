                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form action="/tambah_produk_antara" method="post" enctype="multipart/form-data" role="form" id="forminput1">
                    ...
                    <table class="table" id="tabel1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="/hapus_produk_antara" method="post" id="hapusBB{{$row['spesifikasi_id']}}">
                                        @csrf
