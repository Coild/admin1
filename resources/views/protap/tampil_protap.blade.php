                                        ...
                                        <form action="/input_protap/{{ $jenis }}" method="post"
                                            ...
                                            @if (count($judul) <= 1)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control 1" id="inputNo"
                                                        name="nomor" />
                                                </div>
                                            @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="diajukan" id="inputName" class="form-control 1">
                                                    @foreach ($ajukan as $data)
                                                        <option
                                                            value="{{ $data['namadepan'] }} {{ $data['namabelakang'] }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control 1" id="inputName" name="disetujui"
                                                    value="{{ $pemilik['namadepan'] }} {{ $pemilik['namabelakang'] }}"
                                                    readonly />
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="exampleFormControlFile1">Pilih
                                                    File Protap</label>
                                                <div class="col-sm">
                                                    <input type="file" name="upload" class="form-control 1"
                                        ...
                                        <td>
                                            @if (Auth::user()->level == 2)
                                                <a href="#" type="button" class="btn btn-danger"
                                                    onclick="hapusprotap({msg: 'Apakah Anda Yakin Hapus {{ $row['protap_nama'] }}?',id:{{ $row['protap_id'] }},url:'hapus_protap/{{ $row['protap_id'] }}/{{ $row['protap_jenis'] }}'})">Hapus</a>
                                            @endif
                                            ...
                                            <form action="/lihatpdf" method="post">
                                                ...
                                                <input type="hidden" name="path"
                                                    value="/asset/protap/{{ $row['protap_file'] }}">
