                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <div class="collapse" id="cttpabrik1" aria-labelledby="headingOne" data-bs-parent="#cttpabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="#">Penerimaan Penyerahan dan
                                            Penyimapanan</a>
                                        <a class="nav-link" href="#">Pengambilan Sample</a>
                                        <a class="nav-link" href="#">Program dan Pelatihan
                                            Higiene dan Sanitasi</a>
                                        <a class="nav-link" href="#">Pengoperasian Peralatan
                                            Utama</a>
                                        <a class="nav-link" href="#">Penimbangan</a>
                                        <a class="nav-link" href="{{route('pjt_pengolahanbatch')}}">Pengolahan Batch</a>
                                ...
                                <div class="collapse" id="cttpabrik2" aria-labelledby="headingOne" data-bs-parent="#cttpabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="periksasaniruang">Pembersihan Saniiitasi
                                            Ruangan</a>
                ...
                <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        <div class="collapse" id="collapseLayouts1" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#protappabrik1" aria-expanded="false" aria-controls="protappabrik1" href="#">Dokumentasi
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                                <div class="collapse" id="protappabrik1" aria-labelledby="headingOne" data-bs-parent="#protappabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">

                                        <a class="nav-link" href="{{route('tampil',1)}}">Penerimaan Penyerahan dan
                                            Penyimapanan</a>
                                        <a class="nav-link" href="{{route('tampil',2)}}">Pengambilan Contoh</a>
                                        <a class="nav-link" href="{{route('tampil',3)}}">Spesifikasi Bahan</a>
                                        <a class="nav-link" href="{{route('tampil',4)}}">Pelatihan Higiene dan Sanitasi Bagi
                                            Karyawan</a>
                                        <a class="nav-link" href="{{route('tampil',5)}}">Pengoperasian Peralatan Utama</a>
                                        <a class="nav-link" href="{{route('tampil',6)}}">Struktur Organisasi Personil yang
                                            Menjabat</a>
                                        <a class="nav-link" href="{{route('tampil',7)}}">Penimbangan</a>
                                        <a class="nav-link" href="{{route('tampil',8)}}">Pengolahan Batch</a>
                                        <a class="nav-link" href="{{route('tampil',9)}}">Pengemasan Batch</a>
                                        <a class="nav-link" href="{{route('tampil',10)}}">Peberian Nomor Batch</a>
                                        <a class="nav-link" href="{{route('tampil',11)}}">Pelulusan Produk Jadi</a>
                                        <a class="nav-link" href="{{route('tampil',12)}}">Uji Ulang Bahan Baku</a>
                                        <a class="nav-link" href="{{route('tampil',13)}}">Penanganan Keluhan</a>
                                        <a class="nav-link" href="{{route('tampil',14)}}">Penarikan Produk</a>
                                        <a class="nav-link" href="{{route('tampil',15)}}">Pemusnahan Produk</a>
                                        <a class="nav-link" href="{{route('tampil',16)}}">Penanganan Contoh Tertinggal</a>
                                        <a class="nav-link" href="{{route('tampil',17)}}">Pembuatan PROTAP dan Penomoran</a>
                                        <a class="nav-link" href="{{route('tampil',18)}}">Ceklis & TTD Yang Sudah Dibersihkan</a>
                                    </nav>
                                </div>
                                ...
                                <div class="collapse" id="protappabrik2" aria-labelledby="headingOne" data-bs-parent="#protappabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="{{route('tampil',19)}}">Label Status Kebersihan
                                            Peralatan Sebelum Pengguanaan</a>
                                        <a class="nav-link" href="{{route('tampil',20)}}">Program Pemeriksaan Kesehatan
                                            Untuk Personil Prodi</a>
                                        <a class="nav-link" href="{{route('tampil',21)}}">Pembersihan dan Sanitasi
                                            Peralatan</a>
                                        <a class="nav-link" href="{{route('tampil',22)}}">Pembersihan dan Sanitasi Ruangan</a>
                                        <a class="nav-link" href="{{route('tampil',23)}}">Penerapan Higieni Perorangan</a>
                                    </nav>
                                </div>
                            </nav>
                        </div>
