                                ...
                                <div class="collapse" id="cttpabrik1" aria-labelledby="headingOne" data-bs-parent="#cttpabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="{{route('pendistribusian-produk')}}">Pendistribusian
                                            Produk</a>
                                        <a class="nav-link" href="{{route('penanganan-keluhan')}}">Penanganan Keluhan</a>
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <div class="collapse" id="protappabrik1" aria-labelledby="headingOne" data-bs-parent="#protappabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="program-dan-pelatihan-higiene-dan-sanitasi">Program dan Pelatihan
                                            Higiene dan Sanitasi</a>
                                ...
                                <div class="collapse" id="protappabrik2" aria-labelledby="headingOne" data-bs-parent="#protappabrik0">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="periksapersonil">Label Status Kebersihan
                                            Peralatan Sebelum Pengguanaan</a>
                                        <a class="nav-link" href="periksasaniruang">Program Pemeriksaan Kesehatan
                                            Untuk Personil Prodi</a>
                                        <a class="nav-link" href="periksasanialat">Pembersihan dan Sanitasi
                                            Peralatan</a>
                                        <a class="nav-link" href="#">Pembersihan dan Sanitasi Ruangan</a>
                                        <a class="nav-link" href="#">Penerapan Higieni Perorangan</a>
                                    </nav>
                                </div>
                            </nav>
                        </div>
