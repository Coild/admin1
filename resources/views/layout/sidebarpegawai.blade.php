    ...
    <nav class="sb-sidenav accordion bg-def" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                                ...
                                <div class="collapse" id="protappabrik1" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="{{ route('tampil', 13) }}">Penanganan
                                            Keluhan</a>
                                        <a class="nav-link" href="{{ route('tampil', 25) }}">Pendistribusian
                                            Produk</a>
                                        ...
                                        <a class="nav-link" href="{{ route('tampil', 16) }}">Penanganan Contoh
                                            Tertinggal</a>
                                        <a class="nav-link" href="{{ route('tampil', 24) }}">Penanganan Contoh
                                            Tertinggal</a>
                                        ...
                                        <!-- <a class="nav-link" href="{{ route('tampil', 18) }}">Ceklis & TTD Yang
                                            Sudah Dibersihkan</a> -->
                                        <a class="nav-link" href="{{ route('tampil', 24) }}">Pemeriksaan/Pengujian
                                            Bahan</a>
                                    </nav>
                                </div>
                                <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#protappabrik2"
                                    aria-expanded="false" aria-controls="protappabrik2" href="#">Higiene dan
                                    Sanitasi
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                ...
                <?php
                // $aturan = \App\Models\aturan::all()->where('kategori', 'format')->first(); orderBy('created_at', 'desc')->get();
                $aturan = \App\Models\aturan::orderBy('created_at', 'desc')->where('kategori', 'Aturan Format Baku')->first();
