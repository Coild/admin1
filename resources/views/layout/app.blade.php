...
<body class="sb-nav-fixed" onload="setdatetoday2()">
    ...
    <!-- TES -->
    <!-- datatable -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.1/css/bootstrap.min.css
    ...
    {{-- <script src="{{ secure_asset('js/error.js') }}"></script> --}}
