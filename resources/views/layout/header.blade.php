<nav class="sb-topnav1 navbar1 navbar-expand bg-def">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                @foreach ($notif as $isi)
                                    <li>
                                        <a class="dropdown-item border-radius-md"
                                            href="{{ route($isi['notif_link']) }}">
                                            <div class="d-flex">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="text-sm font-weight-normal mb-1">
                                                        <span
                                                            class="font-weight-bold">{{ $isi['notif_laporan'] }}</span>
                                                        Telah Diterima PJT
                                                    </h6>
                                ...
                                @if ($jum != 0)
                                    <li>
                                        <div class="d-flex">
                                            <div class="d-flex flex-column justify-content-center">
                                                <a href="/notif" class="ml-2">Lihat semua notifikasi <i class="fas fa-arrow-right"></i> </a>
                                            </div>
                                        </div>
                                    </li>
                                @else
    ...
    <ul @if(Auth::user()->level == 3 || Auth::user()->level == 2 ) class="navbar-nav mr-1" @else class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4" @endif >
        <li class="nav-item dropdown">
