<nav class="sb-topnav1 navbar1 navbar-expand sb-navbar-dark bg-secondary">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3 text-dark text-bold" href="/">BPOM RI</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="fas fa-user fa-fw text-dark"></i></a>
