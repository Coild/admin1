...
<center>
    <div class="container">
        ...
        <!-- Isi Surat -->
        <h4 style="text-align: center;">CATATAN PENGAMBILAN CONTOH BAHAN BAKU</h4>
        <div class="form-group">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <br>
                <h5 style="text-align: left;">Nama Bahan Baku: </h5>
                <h5 style="text-align: left;">No Batch: </h5>
                <h5 style="text-align: left;">Tanggal Pengambilan Contoh: </h5>
