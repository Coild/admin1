      ...
      <div class="col-lg-8 col-md-8 d-none d-md-block image-container"></div>
        ...
        <div class="col-lg-4 col-md-4 container" >
          <div class="text-center">
            <img src="assets/img/bpom1.jpg" style="width: 25%; margin-top:5%;" class="img-fluid" alt="Responsive image" background-repeat:>
          </div>
            ...
            <div class="card-body">
              <form id='forminput' action="/login" method="post" has-recaptcha-v2>
                ...
                <div class="form-floating mb-3">
                  ...
                  <input name="username" class="form-control" id="inputEmail" type="text" placeholder="Masukan Username" />
                ...
                <div class="g-recaptcha" data-callback="recaptcha_callback" data-sitekey="6Lecb2YfAAAAAIR2uhydBgujcJ7VLBleTtAkDFQJ"></div>
