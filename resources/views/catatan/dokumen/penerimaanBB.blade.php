                            ...
                            <form role="form" method="post" action="tambah_terimabahan" id='forminput3'>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input class="form-control 3" list="listnamabahanbaku" type="text" name='nama' id="namabahanbaku" autocomplete="off" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                            Bahan Baku</label>
                                        <div class="col-sm">
                                            <input type="text" name="kode" readonly class="form-control 3" id="kodebahanbaku" placeholder="Kode Bahan Baku" required />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm">
                                            <div class="row">
                                                <div class="col-sm-8" data-tip="Hanya angka saja" >
                                                    <input type="number" name="jumlah" class="form-control 3" id="inputEmail3" placeholder="Jumlah" />
                                                </div>
                                                <div class="col-sm-4">
                            ...
                            <form role="form" method="post" action="tambah_terimaproduk" id='forminput2'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            <div class="col-sm-8" data-tip="Hanya angka saja">
                                                <input type="number" name="jumlah" class="form-control 2" id="inputEmail3" placeholder="Jumlah" />
                                            </div>
                                            <div class="col-sm-4">
                                                <select class="form-select" name="satuan" id="">
                            ...
                            <form role="form" method="post" action="tambah_terimakemasan" id='forminput1'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            <div class="col-sm-8" data-tip="Hanya angka saja">
                                                <input type="number" name="jumlah" class="form-control 1" id="inputEmail3" placeholder="Jumlah" />
                                            </div>
                                            <div class="col-sm-4">
                                                <select class="form-select" name="satuan" id="">
                                                    <option value="pcs"> pcs</option>
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            <div class="col-sm-8" data-tip1="Hanya angka saja">
                                                <input type="number" id="bahanjumlah" name="jumlah" class="form-control 4" id="jumlah" placeholder="Jumlah" />
                                            </div>
                                            <div class="col-sm-4">
                            ...
                            <form role="form" method="post" action="edit_terimaproduk" id='forminput5'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            <div class="col-sm-8" data-tip="Hanya angka saja">
                                                <input type="number" id="produkjumlah" name="jumlah" class="form-control 5" id="Jumlah" placeholder="Jumlah" />
                                            </div>
                                            <div class="col-sm-4">
                            ...
                            <form role="form" method="post" action="edit_terimakemasan" id='forminput6'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            <div class="col-sm-8" data-tip="Hanya angka saja">
                                                <input type="number" id="kemasanjumlah" name="jumlah" class="form-control 6" id="jumlah" placeholder="Jumlah" />
                                            </div>
                                            <div class="col-sm-4">
