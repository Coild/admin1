                        ...
                        <div class="card-body">
                            ...
                            <form role="form" method="post" action="tambah_terimabahan" id='forminput3'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <select style="height: 35px;" id='kode_bahan' class="form-control 3" name="kode">
                                            <option selected>Choose...</option>
                                            @foreach ($bahanbaku as $row)
                                            <option value="{{ $row['bahanbaku_kode'] }}" data-nama="{{ $row['bahanbaku_nama'] }}">
                                                {{ $row['bahanbaku_kode'] }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                        Bahan</label>
                                    <div class="col-sm">
                                        <input type="text" name="nama" readonly class="form-control 3" id="nama_bahan" placeholder="Nama Bahan" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="produk" class="form-control 3" id="inputEmail3" placeholder="Untuk Produk" />
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form role="form" method="post" action="tambah_terimaproduk" id='forminput2'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <select style="height: 35px;" id='kodeproduk' class="form-control 2" name="kode">
                                            <option selected>Choose...</option>
                                            @foreach ($produk as $row)
                                            <option value="{{ $row['produk_kode'] }}" data-nama="{{ $row['produk_nama'] }}">
                                                {{ $row['produk_kode'] }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                        Produk</label>
                                    <div class="col-sm">
                                        <input type="text" name="nama" readonly class="form-control 2" id="namaproduk" placeholder="Nama Produk" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" name="produk" class="form-control 2" id="inputEmail3" placeholder="Jenis Kemasan" />
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form role="form" method="post" action="tambah_terimakemasan" id='forminput1'>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <select style="height: 35px;" id='kodekemasan' class="form-control 1" name="kode">
                                                <option selected>Choose...</option>
                                                @foreach ($kemasan as $row)
                                                <option value="{{ $row['kemasan_kode'] }}" data-nama="{{ $row['kemasan_nama'] }}">
                                                    {{ $row['kemasan_kode'] }}
                                                </option>
                                                @endforeach
                                            </select>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form role="form" method="post" action="tambah_terimakemasan" id='forminput1'>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="nama" class="form-control 1" id="inputEmail3" placeholder="Nama Kemasan" />
                                                        ...
                                                        <<<<<<< HEAD <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                Kemasan</label>
                                                            <div class="col-sm">
                                                                <input type="text" name="nama" readonly class="form-control 1" id="namakemasan" placeholder="Nama Kemasan" />
                                                            </div>
                                                            =======
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Untuk
                                                                    Produk</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="produk" class="form-control 1" id="inputEmail3" placeholder="Untuk Produk" />
                                                                    >>>>>>> 9f0d3b8be34099fb5bee50299f715615108339b5
                                                                </div>
                                                            </div>
                                                            ...
                                                            <<<<<<< HEAD <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                        Kemasan</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="kode" class="form-control 1" id="inputEmail3" placeholder="Kode Kemasan" />
                                                                        >>>>>>> 9f0d3b8be34099fb5bee50299f715615108339b5
                                                                    </div>
                                                                </div>
