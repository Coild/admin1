                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($row['status'] == 0) { ?>
                                                    ...
                                                    <form method="post" action="terimapenimbanganbahan" id="terimatimbangbahan{{ $row['timbang_bahan_id'] }}">
                                                        @csrf
                                                ...
                                                <?php } elseif ($row['status'] == 1) { ?>
                                                    ...
                                                    <button id="klik_bahan" type="submit" class="btn btn-danger disabled" data-toggle="modal" data-target="#editBahan" data-tanggal="{{ $row['tanggal'] }}" data-nama="{{ $row['nama_bahan'] }}" data-noloth="{{ $row['no_loth'] }}" data-suplai="{{ $row['nama_suplier'] }}" data-jbahan="{{ $row['jumlah_bahan'] }}" data-hasil="{{ $row['hasil_penimbangan'] }}" data-id="{{ $row['timbang_bahan_id'] }}">edit</button>
                                                <?php } ?>
                                                @endif
                                            </td>
                                        </tr>
                                                        ...
                                                        <form role="form" method="post" action="tambah_ruangtimbang" id='forminput3'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Bahan
                                                                    Baku</label>
                                                                <div class="col-sm">
                                                                    <input class="form-control 3" list="listnamabahanbaku" type="text" name='nama_bahanbaku' id="namabahanbaku" autocomplete="off">
                                                                    </input>
                                                                ...
                                                                <div class="col-sm">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-8" data-tip="Hanya angka saja">
                                                                            <input type="number" name="jumlah_bahanbaku" class="form-control 3" id="inputEmail3" placeholder="Jumlah Bahan Baku" />
                                                                        </div>
                                                                        <div class="col-sm-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->level == 2)
                                                <?php if ($row['status'] == 0) { ?>
                                                    <form method="post" action="terimapenimbanganruang" id= "terimatimbangruang{{ $row['id_ruangtimbang'] }}">
                                                        @csrf
                        ...
                        <form role="form" method="post" action="edit_ruangtimbang" id='forminput6'>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Bahan
                                    Baku</label>
                                <div class="col-sm">
                                    <input class="form-control 6" list="listnamabahanbaku" type="text" name='nama_bahanbaku' id="isi_namaruang" autocomplete="off">
                                    </input>
                                    <datalist id='listnamabahanbaku'>
                                        @foreach ($bahanbaku as $row)
                                        <option value="{{ $row['bahanbaku_nama'] }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8" data-tip="Hanya angka saja">
                                            <input type="number" name="jumlah_bahanbaku" class="form-control 6" id="isi_jruang" placeholder="Jumlah Bahan Baku" />
                                        </div>
                                        <div class="col-sm-4">
