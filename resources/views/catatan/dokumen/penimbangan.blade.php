...
<main>
    <div class="container-fluid px-4">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Ruang Timbang</a>
            </li>
        </ul>
                                                        ...
                                                        <form role="form" method="post" action="tambah_penimbanganbahan" id='forminput1'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Penimbangan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_penimbangan" class="form-control 1" id="inputEmail3" placeholder="Kode Penimbangan" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Suplier</label>
                                                                <div class="col-sm">
                                                        ...
                                                        <form role="form" method="post" action="tambah_penimbanganprodukantara" id='forminput2'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Penimbangan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_produk" class="form-control 2" id="inputEmail3" placeholder="Kode Penimbangan" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form role="form" method="post" action="tambah_ruangtimbang" id='forminput3'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Ruang Timbang</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_ruangtimbang" class="form-control 3" id="inputEmail3" placeholder="Kode Ruang Timbang" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                    Bahan Baku</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nama_bahanbaku" class="form-control 3" id="inputEmail3" placeholder="Nama Bahan Baku" />
                                                                </div>
                                                            </div>
