                                                ...
                                                <tr>
                                                    ...
                                                    @if (Auth::user()->level != 2)
                                                        <td>
                                                            ...
                                                            <a href="#" type="submit" data-toggle="modal"
                                                                data-target="#modalForm4" class="btn btn-danger disabled"
                                                                onclick="editdata1({{ $row }})">Edit</a>
                                                            <?php } ?>
                                                    ...
                                                    @else
                                                        <td>
                                                            ...
                                                            <form method="post" action="terimakartustokbahan"
                                                                id="formTerimaLaporan{{ $row['id_kartustokbahan'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_kartustokbahan'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan({{ $row['id_kartustokbahan'] }})"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (Auth::user()->level != 2)
                                                            ...
                                                            <?php } elseif ($row['status'] == 1) { ?>
                                                            <a href="#" type="submit" data-toggle="modal"
                                                                data-target="#modalForm5" class="btn btn-danger disabled"
                                                                onclick="editdata2({{ $row }})">Edit</a>
                                                            <?php } ?>
                                                        @else
                                                            <?php if ($row['status'] == 0) { ?>
                                                            <form method="post" action="terimakartustokbahankemas"
                                                                id="formTerimaLaporan2{{ $row['id_kartustokbahankemas'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_kartustokbahankemas'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan2({{ $row['id_kartustokbahankemas'] }})"
                                                                    class="btn btn-primary">Terima</button>
                                                            </form>
                                                ...
                                                <tr>
                                                    ...
                                                    @if (Auth::user()->level != 2)
                                                        <td>
                                                            ...
                                                            <?php } elseif ($row['status'] == 1) { ?>
                                                            <a href="#" type="submit" data-toggle="modal"
                                                                data-target="#modalForm3" class="btn btn-danger disabled"
                                                                onclick="editdata3({{ $row }})">Edit</a>
                                                            <?php } ?>
                                                    ...
                                                    @else
                                                        <td>
                                                            ...
                                                            <form method="post" action="terimakartustokprodukantara"
                                                                id="formTerimaLaporan3{{ $row['id_kartustokprodukantara'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_kartustokprodukantara'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan3({{ $row['id_kartustokprodukantara'] }})"
                                                                    class="btn btn-primary">Terima</button>
                                                            </form>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            ...
                                                            <form method="post" action="terimakartustokprodukjadi"
                                                                id="formTerimaLaporan4{{ $row['id_kartustokprodukjadi'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_kartustokprodukjadi'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan4({{ $row['id_kartustokprodukjadi'] }})"
                                                                    class="btn btn-primary">Terima</button>
                                                            </form>
