                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Kode
                                                                        Kartu Stok</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="kode_stok" class="form-control 1" id="inputEmail3" placeholder="Kode Kartu Stok" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                                                        Batch</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="no_batch" class="form-control 1" id="inputEmail3" placeholder="No Batch" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                        Distributor</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="nama_distributor" class="form-control 1" id="inputEmail3" placeholder="Nama Distributor" />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Kode
                                                                        Kartu Stok</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="kode_stok" class="form-control 2" id="inputEmail3" placeholder="Kode Kartu Stok" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                                                        Batch</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="no_batch" class="form-control 2" id="inputEmail3" placeholder="No Batch" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                        Distributor</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="nama_distributor" class="form-control 2" id="inputEmail3" placeholder="Nama Distributor" />
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="card mb-4">
                                                    ...
                                                    <div class="card-body">
                                                        <p class="statusMsg"></p>
                                                        <form role="form" method="post" action="tambah_kartustokprodukjadi" id='forminput3'>
                                                            @csrf
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Kode
                                                                        Kartu Stok</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="kode_stok" class="form-control 3" id="inputEmail3" placeholder="Kode Kartu Stok" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                                                        Batch</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="no_batch" class="form-control 3" id="inputEmail3" placeholder="No Batch" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                        Distributor</label>
                                                                    <div class="col-sm">
                                                                        <input type="text" name="nama_distributor" class="form-control 3" id="inputEmail3" placeholder="Nama Distributor" />
                                                                    </div>
                                                                </div>
