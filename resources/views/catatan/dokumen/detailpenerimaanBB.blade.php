                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form role="form" id="forminput1"
                                                action="{{ url('tambah_penerimaanbbmasuk') }}" method="post">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Sesuai
                                                        ...
                                                        No</label>
                                                    <div class="col-sm">
                                                        <input type="text" class="form-control 1" placeholder="Nomor PROTAP"
                                                            name='pob_no'>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm"><input type="text" class="form-control 1"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data1 as $row)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button id="klikbahanmasuk" data-toggle="modal"
                                                        data-target="#editbahanmasuk"
                                                        data-tanggal="{{ $row['tanggal'] }}"
                                                        data-nama="{{ $row['nama_bahan'] }}"
                                                        data-noloth="{{ $row['no_loth'] }}"
                                                        data-pemasok="{{ $row['pemasok'] }}"
                                                        data-nokontrol="{{ $row['no_loth'] }}"
                                                        data-jumlah="{{ $row['jumlah'] }}"
                                                        data-protap="{{ $row['no_pob'] }}"
                                                        data-id={{ $row['id_ppbahanbaku'] }}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="statusMsg"></p>
                                            <form role="form" id="forminput2"
                                                action="{{ url('tambah_penerimaanbbkeluar') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <input type="hidden" name="induk" value="{{ $induk }}">
                                                <input type="hidden" name="jenis" value="{{ $jenis }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                                    <div class="col-sm"><input type="text" class="form-control 2"
                                                            name="jumlah" placeholder="Jumlah" /></div>
                                                </div>
                                                <div class="form-group row">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data2 as $row)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button type="button" id="klikbahankeluar" data-toggle="modal"
                                                        data-target="#editbahankeluar" data-tanggal={{ $row['tanggal'] }}
                                                        data-nama={{ $row['nama_bahan'] }}
                                                        data-produk={{ $row['untuk_produk'] }}
                                                        data-nobatch={{ $row['no_batch'] }}
                                                        data-jumlah={{ $row['jumlah'] }}
                                                        data-sisa={{ $row['sisa'] }}
                                                        data-id={{ $row['id_ppbahanbakukeluar'] }}
                                                        class="btn btn-primary">Edit</button>
                                                </td>
                                            @endif
                                        </tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="statusMsg"></p>
                                            <form role="form" id="forminput3"
                                                action="{{ url('tambah_penerimaanprdukmasuk') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <input type="hidden" name="induk" value="{{ $induk }}">
                                                <input type="hidden" name="jenis" value="{{ $jenis }}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm">
                                                        <input type="text" class="form-control 3"
                                                            placeholder="Nomor PROTAP" name='pob_no'>
                                                    </div>
                                                </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data1 as $row)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button type="button" id="klikprodukmasuk" data-toggle="modal"
                                                        data-target="#editprodukmasuk"
                                                        data-tanggal="{{ $row['tanggal'] }}"
                                                        ...
                                                        data-jumlah="{{ $row['jumlah'] }}"
                                                        data-protap="{{ $row['no_pob'] }}"
                                                        data-id={{ $row['id_produkjadimasuk'] }}
                                                        class="btn btn-primary">Edit</button>
                                                </td>
                                            @endif
                                        </tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="statusMsg"></p>
                                            <form role="form" id="forminput4"
                                                action="{{ url('tambah_penerimaanprodukkeluar') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <input type="hidden" name="induk" value="{{ $induk }}">
                                                <input type="hidden" name="jenis" value="{{ $jenis }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                                    <div class="col-sm"><input type="text" class="form-control 4"
                                                            name="jumlah" placeholder="Jumlah" /></div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    ...
                                                    <button type="submit" id="klikprodukkeluar" data-toggle="modal"
                                                        data-target="#editprodukkeluar"
                                                        data-tanggal={{ $row['tanggal'] }}
                                                        ...
                                                        data-jumlah="{{ $row['jumlah'] }}"
                                                        data-sisa="{{ $row['sisa'] }}"
                                                        data-id={{ $row['id_ppprodukjadikeluar'] }}
                                                        class="btn btn-primary">Edit</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="statusMsg"></p>
                                            <form role="form" id="forminput5"
                                                action="{{ url('tambah_penerimaakemasanmasuk') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <input type="hidden" name="induk" value="{{ $induk }}">
                                                <input type="hidden" name="jenis" value="{{ $jenis }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                                    <div class="col-sm"><input type="text" class="form-control 5"
                                                            name="jumlah" placeholder="Jumlah" /></div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data1 as $row)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button type="button" id="klikkemasanmasuk" data-toggle="modal"
                                                        data-target="#editkemasanmasuk"
                                                        data-tanggal="{{ $row['tanggal'] }}"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form role="form" id="forminput6"
                                                action="{{ url('tambah_penerimaankemasankeluar') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                <input type="hidden" name="induk" value="{{ $induk }}">
                                                <input type="hidden" name="jenis" value="{{ $jenis }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                                    <div class="col-sm"><input type="text" class="form-control 6"
                                                            name="jumlah" placeholder="Jumlah" /></div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data2 as $row)
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button type="button" id="klikkemasankeluar" data-toggle="modal"
                                                        data-target="#editkemasankeluar"
                                                        data-tanggal={{ $row['tanggal'] }}
                                                        data-nama={{ $row['nama_bahan'] }}
                                                        data-produk={{ $row['untuk_produk'] }}
                                                        data-nobatch={{ $row['no_batch'] }}
                                                        data-jumlah={{ $row['jumlah'] }}
                                                        data-sisa={{ $row['sisa'] }}
                                                        data-id={{ $row['id_ppkemasankeluar'] }}
                                                        class="btn btn-primary">Edit</button>
                                                </td>
                                            @endif
                                        </tr>
                        ...
                        <form role="form" id="forminput7" action="{{ url('edit_penerimaanbbmasuk') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Sesuai
                                    ...
                                    No</label>
                                <div class="col-sm">
                                    <input type="text" id="bahanmasuk_protap" class="form-control 7"
                                        placeholder="Nomor PROTAP" name='pob_no'>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Loth</label>
                                <div class="col-sm">
                                    <input type="text" id="bahanmasuk_noloth" class="tanggal" name="no_loth"
                                        placeholder="Nomor Loth" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" id="bahanmasuk_jumlah"
                                        class="form-control 7" name="jumlah" placeholder="Jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Kontrol</label>
                                <div class="col-sm">
                                    <input type="text" id="bahanmasuk_nokontrol" class="form-control 7" name="no_kontrol"
                                        placeholder="Nomor Kontrol" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="inputEmail3">Tanggal
                                    Kadaluarsa</label>
                                <div class="col-sm">
                                    <input type="date" id="bahanmasuk_kadaluarsa" name="kedaluwarsa"
                        ...
                        <form role="form" id="forminput8" action="{{ url('edit_penerimaanbbkeluar') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Batch</label>
                                <div class="col-sm">
                                    <input type="text" id="bahankeluar_nobatch" class="form-control 8" name="no_batch"
                                        placeholder="Nomor Batch" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" id="bahankeluar_jumlah"
                                        class="form-control 8" name="jumlah" placeholder="Jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                <div class="col-sm">
                                    <input type="text" id="bahankeluar_sisa" class="form-control 8" name="sisa"
                                        placeholder="Sisa" />
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="statusMsg"></p>
                        <form role="form" id="forminput9" action="{{ url('edit_penerimaanprdukmasuk') }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="induk" value="{{ $induk }}">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Sesuai
                                    ...
                                    No</label>
                                <div class="col-sm">
                                    <input type="text" id="produkmasuk_protap" class="form-control 9"
                                        placeholder="Nomor PROTAP" name='pob_no'>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Loth</label>
                                <div class="col-sm">
                                    <input type="text" id="produkmasuk_noloth" class="form-control 9" name="no_loth"
                                        placeholder="Nomor Loth" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" id="produkmasuk_jumlah"
                                        class="form-control 9" name="jumlah" placeholder="Jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Kontrol</label>
                                <div class="col-sm">
                                    <input type="text" id="produkmasuk_nokontrol" class="form-control 9" name="no_kontrol"
                                        placeholder="Nomor Kontrol" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="inputEmail3" id="produkmasuk_kadaluarsa">Tanggal
                                    Kadaluarsa</label>
                                <div class="col-sm">
                                    <input type="date" id="produkmasuk_kadaluarsa" name="kedaluwarsa"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="statusMsg"></p>
                        <form role="form" id="forminput10" action="{{ url('edit_penerimaanprodukkeluar') }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="induk" value="{{ $induk }}">
                            ...
                            <input type="hidden" name="tanggal" id='ambil_tanggal4' class="tanggal"
                                placeholder="" />
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Batch</label>
                                <div class="col-sm">
                                    <input type="text" class="form-control 10" name="no_batch" placeholder="Nomor Batch"
                                        id="produkkeluar_nobatch" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" class="form-control 10" name="jumlah"
                                        placeholder="Jumlah" id="produkkeluar_jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                <div class="col-sm">
                                    <input type="text" class="form-control 10" name="sisa" placeholder="Sisa"
                                        id="produkkeluar_sisa" />
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="statusMsg"></p>
                        <form role="form" id="forminput11" action="{{ url('edit_penerimaakemasanmasuk') }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="induk" value="{{ $induk }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="text" class="form-control 11" placeholder="Nomor PROTAP" name='pob_no'
                                        id="kemasanmasuk_protap">
                                </div>
                            </div>
                            <input type="hidden" name="tanggal" id='ambil_tanggal5' class="tanggal"
                                placeholder="" />
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Loth</label>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" class="form-control 11" name="jumlah"
                                        placeholder="Jumlah" id="kemasanmasuk_jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Kontrol</label>
                                <div class="col-sm">
                                    <input type="text" class="form-control 11" name="no_kontrol"
                                        placeholder="Nomor Kontrol" id="kemasanmasuk_nokontrol" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="inputEmail3" id="kemasanmasuk_kadaluarsa">Tanggal
                                    Kadaluarsa</label>
                                <div class="col-sm">
                                    <input type="date" id="kemasanmasuk_kadaluarsa" name="kedaluwarsa"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="statusMsg"></p>
                        <form role="form" id="forminput12" action="{{ url('edit_penerimaankemasankeluar') }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="induk" value="{{ $induk }}">
                            ...
                            <input type="hidden" name="tanggal" id='ambil_tanggal6' class="tanggal"
                                placeholder="" />
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                    Batch</label>
                                <div class="col-sm">
                                    <input type="text" class="form-control 12" name="no_batch" placeholder="Nomor Batch"
                                        id="kemasankeluar_nobatch" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm"><input type="text" class="form-control 12" name="jumlah"
                                        placeholder="Jumlah" id="kemasankeluar_jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                <div class="col-sm">
                                    <input type="text" class="form-control 12" name="sisa" placeholder="Sisa"
                                        id="kemasankeluar_sisa" />
                                </div>
                            </div>
                        </form>
                    </div>
