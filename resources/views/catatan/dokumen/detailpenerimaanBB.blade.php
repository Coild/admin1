                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput1" action="{{ url('tambah_penerimaanbbmasuk') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber" class="form-control 1" name="jumlah" placeholder="Jumlah" /></div>
                                        </div>
                                        <br>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                    ...
                    <table id="tabel1" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($status == 0)
                                    <button id="klikbahanmasuk" data-toggle="modal" data-target="#editbahanmasuk" data-tanggal="{{ $row['tanggal'] }}" data-kedaluwarsa="{{ $row['kedaluwarsa'] }}" data-nama="{{ $row['nama_bahan'] }}" data-noloth="{{ $row['no_loth'] }}" data-pemasok="{{ $row['pemasok'] }}" data-nokontrol="{{ $row['no_kontrol'] }}" data-jumlah="{{ $row['jumlah'] }}" data-protap="{{ $row['no_pob'] }}" data-id={{ $row['id_ppbahanbaku'] }} class="btn btn-primary">Edit</button>
                                    @else
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput2" action="{{ url('tambah_penerimaanbbkeluar') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber1" class="form-control 2" name="jumlah" placeholder="Jumlah" /></div>
                                        </div>
                                        <br>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                            <div class="col-sm" data-tip="Hanya angka saja">
                                                <input type="number" id="inputnumber3" class="form-control 2" name="sisa" placeholder="Sisa" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput3" action="{{ url('tambah_penerimaanprdukmasuk') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber4"  class="form-control 3" name="jumlah" placeholder="Jumlah" />
                    ...
                    <table id="tabel3" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($status == 0)
                                    <button type="button" id="klikprodukmasuk" data-toggle="modal" data-target="#editprodukmasuk" data-tanggal="{{ $row['tanggal'] }}" 
                                    data-kedaluwarsa="{{ $row['kedaluwarsa'] }}" data-nama="{{ $row['nama_produkjadi'] }}" data-noloth="{{ $row['no_loth'] }}" data-pemasok="{{ $row['pemasok'] }}" data-nokontrol="{{ $row['no_kontrol'] }}" data-jumlah="{{ $row['jumlah'] }}" data-protap="{{ $row['no_pob'] }}" data-id={{ $row['id_produkjadimasuk'] }} class="btn btn-primary">Edit</button>
                                    @else
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput4" action="{{ url('tambah_penerimaanprodukkeluar') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber5" class="form-control 4" name="jumlah" placeholder="Jumlah" /></div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                            <div class="col-sm" data-tip="Hanya angka saja">
                                                <input type="number" id="inputnumber6" class="form-control 4" name="sisa" placeholder="Sisa" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput5" action="{{ url('tambah_penerimaakemasanmasuk') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber7" class="form-control 5" name="jumlah" placeholder="Jumlah" /></div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                                Kontrol</label>
                    ...
                    <table id="tabel5" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($status == 0)
                                    <button type="button" id="klikkemasanmasuk" data-toggle="modal" data-target="#editkemasanmasuk" data-tanggal="{{ $row['tanggal'] }}" data-kedaluwarsa="{{ $row['kedaluwarsa'] }}" data-nama="{{ $row['nama_kemasan'] }}" data-noloth="{{ $row['no_loth'] }}" data-pemasok="{{ $row['pemasok'] }}" data-nokontrol="{{ $row['no_kontrol'] }}" data-jumlah="{{ $row['jumlah'] }}" data-protap="{{ $row['no_pob'] }}" data-id={{ $row['id_kemasanmasuk'] }} class="btn btn-primary">Edit</button>
                                    @else
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" id="forminput6" action="{{ url('tambah_penerimaankemasankeluar') }}" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber8" class="form-control 6" name="jumlah" placeholder="Jumlah" /></div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                            <div class="col-sm" data-tip="Hanya angka saja">
                                                <input type="number" class="form-control 6" id="inputnumber9" name="sisa" placeholder="Sisa" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="forminput7" action="{{ url('edit_penerimaanbbmasuk') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                            <div class="col-sm" data-tip="Hanya angka saja">
                                <input type="number" id="inputnumber10" id="bahanmasuk_jumlah" class="form-control 7" name="jumlah" placeholder="Jumlah" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="forminput8" action="{{ url('edit_penerimaanbbkeluar') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber10" id="bahankeluar_jumlah" class="form-control 8" name="jumlah" placeholder="Jumlah" /></div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                            <div class="col-sm" data-tip="Hanya angka saja">
                                <input type="number" id="inputnumber11" id="bahankeluar_sisa" class="form-control 8" name="sisa" placeholder="Sisa" />
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="forminput9" action="{{ url('edit_penerimaanprdukmasuk') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber12" id="produkmasuk_jumlah" class="form-control 9" name="jumlah" placeholder="Jumlah" /></div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                Kontrol</label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="inputEmail3" id="produkmasuk_kadaluarsaedit">Tanggal
                                Kadaluarsa</label>
                            <div class="col-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="forminput10" action="{{ url('edit_penerimaanprodukkeluar') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number" id="inputnumber13" class="form-control 10" name="jumlah" placeholder="Jumlah" id="produkkeluar_jumlah" /></div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                            <div class="col-sm" data-tip="Hanya angka saja">
                                <input type="number" id="inputnumber14" class="form-control 10" name="sisa" placeholder="Sisa" id="produkkeluar_sisa" />
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="forminput11" action="{{ url('edit_penerimaakemasanmasuk') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                            <div class="col-sm" data-tip="Hanya angka saja"><input type="number"  id="inputnumber15" class="form-control 11" name="jumlah" placeholder="Jumlah" id="kemasanmasuk_jumlah" /></div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-3 col-form-label">Nomer
                                Kontrol</label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="inputEmail3" id="kemasanmasuk_kadaluarsaedit">Tanggal
                                Kadaluarsa</label>
                            <div class="col-sm">
    ...
    <div class="modal fade" id="editkemasankeluar" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form" id="forminput12" action="{{ url('edit_penerimaankemasankeluar') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Jumlah</label>
                                <div class="col-sm" data-tip="Hanya angka saja"><input type="number"  id="inputnumber16" class="form-control 12" name="jumlah" placeholder="Jumlah" id="kemasankeluar_jumlah" /></div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-sm-3 col-form-label">Sisa</label>
                                <div class="col-sm" data-tip="Hanya angka saja">
                                    <input type="number" id="inputnumber17" class="form-control 12" name="sisa" placeholder="Sisa" id="kemasankeluar_sisa" />
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script>
            $(document).on('click', "#klikbahanmasuk", function() {
                ...
                var kadaluarsa = $(this).data('kedaluwarsa');
                var id = $(this).data('id');
