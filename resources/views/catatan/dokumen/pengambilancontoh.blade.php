                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm">
                                                                            <input class="form-control 1"
                                                                                ...
                                                                                name='nama_bahan' id="namabahanbaku" autocomplete="off">
                                                                            </input>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <form role="form" method="post" action="tambah_contohproduk"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm">
                                                                        <input type="text" name="nobatch"
                                                                            class="form-control 2" placeholder="No Batch" />
                                                                    </div>
                                                                </div>
                                ...
                                <form role="form" method="post" action="edit_contohbahan" id='forminput7'>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                            Batch</label>
                                        <div class="col-sm">
                                            <input type="text" name="nobatch" class="form-control 7" placeholder="No Batch"
                                                id="bahan_nobatch" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input type="date" name="kedaluwarsa" class="form-control 7" placeholder=""
                                                id="bahan_kadaluarsa" />
                                        </div>
                                    </div>
                                ...
                                <form role="form" method="post" action="edit_contohproduk" id='forminput8'>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                            Batch</label>
                                        <div class="col-sm">
                                            <input type="text" name="nobatch" class="form-control 8" placeholder="No Batch"
                                                id="produk_nobatch" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kedaluwarsa</label>
                                        <div class="col-sm">
                                            <input type="date" name="kedaluwarsa" class="form-control 8" placeholder=""
                                                id="produk_kadaluarsa" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah
                                            Produk dalam Box</label>
                                        <div class="col-sm">
                                            <input type="text" name="jumlah_box" class="form-control 8"
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah
                                            Produk Yang Diambil</label>
                                        <div class="col-sm">
                                            <input type="text" name="jumlah_ambil" class="form-control 8"
                                ...
                                <form role="form" method="post" action="edit_contohkemasan" id='forminput9'>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                            Batch</label>
                                        <div class="col-sm">
                                            <input type="text" name="nobatch" class="form-control 9" placeholder="No Batch"
                                                id="kemasan_nobatch" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kedaluwarsa</label>
                                        <div class="col-sm">
                                            <input type="date" name="kedaluwarsa" class="form-control 9" placeholder=""
                                                id="kemasan_kadaluarsa" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah
                                            Kemasan dalam Box</label>
                                        <div class="col-sm">
                                            <input type="text" name="jumlah_box" class="form-control 9"
