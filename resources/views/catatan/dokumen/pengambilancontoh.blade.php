                                                        ...
                                                        <form role="form" method="post" action="tambah_contohbahan" id='forminput1'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Nama Bahan
                                                                    Baku</label>
                                                                <div class="col-sm">
                                                                    <input class="form-control 1" list="listnamabahanbaku" type="text" name='nama_bahan' id="namabahanbaku" autocomplete="off">
                                                                    </input>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form role="form" method="post" action="tambah_contohproduk" id='forminput2'>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input class="form-control 2" list="listnamaproduk" type="text" name='nama_produk' id="namaproduk" autocomplete="off">
                                                                    </input>
                                                        ...
                                                        <form role="form" method="post" action="tambah_contohkemasan" id='forminput3'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                    Kemasan</label>
                                                                <div class="col-sm">
                                                                    <input class="form-control 3" list="listnamakemasan" type="text" name='nama_kemasan' id="namakemasan" autocomplete="off">
                                                                    </input>
                        ...
                        <div class="card-body">
                            ...
                            <form role="form" method="post" action="edit_contohproduk" id='forminput8'>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Produk</label>
                                    <div class="col-sm">
                                        <input class="form-control 8" list="listnamaproduk" type="text" name='nama_produk' id="produk_nama" autocomplete="off">
                                        <datalist id='listnamaproduk'>
                                            @foreach ($produk as $row)
                                            <option value="{{ $row['produk_nama'] }}">
                                                {{ $row['produk_nama'] }}
                            ...
                            <form role="form" method="post" action="edit_contohkemasan" id='forminput9'>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                        Kemasan</label>
                                    <div class="col-sm">
                                        <input class="form-control 9" list="listnamakemasan" type="text" name='nama_kemasan' id="kemasan_nama" autocomplete="off">
                                        <datalist id='listnamakemasan'>
                                            @foreach ($kemasan as $row)
                                            <option value="{{ $row['kemasan_nama'] }}">
                                                {{ $row['kemasan_nama'] }}
