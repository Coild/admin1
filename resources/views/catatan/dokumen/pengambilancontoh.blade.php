                                                        ...
                                                        <form role="form" method="post" action="tambah_contohbahan" id='forminput1'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Bahan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_bahan" class="form-control 1" id="inputEmail3" placeholder="Kode Bahan" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                    Bahan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nama_bahan" class="form-control 1" id="inputEmail3" placeholder="Nama Bahan" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                                                    Batch</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nobatch" class="form-control 1" id="inputEmail3" placeholder="No Batch" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="date" name="kedaluwarsa" class="form-control 1" id="inputEmail3" placeholder="" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_box" class="form-control 1" id="inputEmail3" placeholder="Jumlah Jumlah
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_ambil" class="form-control 1" id="inputEmail3" placeholder="Jumlah Produk Yang Diambil" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="text" name="jenis_warna_kemasan" class="form-control 1" id="inputEmail3" placeholder="Jenis dan Warna Kemasan" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form role="form" method="post" action="tambah_contohproduk" id='forminput2'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Produk</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_produk" class="form-control 2" id="inputEmail3" placeholder="Kode Produk" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                    Produk</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nama_produk" class="form-control 2" id="inputEmail3" placeholder="Nama Produk" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kedaluwarsa</label>
                                                                <div class="col-sm">
                                                                    <input type="date" name="kedaluwarsa" class="form-control 2" id="inputEmail3" placeholder="" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_box" class="form-control 2" id="inputEmail3" placeholder="Jumlah Produk Dalam Box" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah
                                                                    Produk Yang Diambil</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_ambil" class="form-control 2" id="inputEmail3" placeholder="Jumlah Produk Yang Diambil" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Jenis
                                                                    dan Warna Kemasan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="jenis_warna_kemasan" class="form-control 2" id="inputEmail3" placeholder="Jenis dan Warna Kemasan" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form role="form" method="post" action="tambah_contohkemas" id='forminput3'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                                    Kemasan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="kode_kemasan" class="form-control 3" id="inputEmail3" placeholder="Kode Kemasan" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                    Kemasan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nama_kemasan" class="form-control 3" id="inputEmail3" placeholder="Nama Kemasan" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                                                    Batch</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="nobatch" class="form-control 3" id="inputEmail3" placeholder="No Batch" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kedaluwarsa</label>
                                                                <div class="col-sm">
                                                                    <input type="date" name="kedaluwarsa" class="form-control 3" id="inputEmail3" placeholder="" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_box" class="form-control 3" id="inputEmail3" placeholder="Jumlah Kemasan dalam Box" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah
                                                                    Produk Yang Diambil</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="jumlah_ambil" class="form-control 3" id="inputEmail3" placeholder="Jumlah Produk Yang Diambil" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Jenis
                                                                    dan Warna Kemasan</label>
                                                                <div class="col-sm">
                                                                    <input type="text" name="jenis_warna_kemasan" class="form-control 3" id="inputEmail3" placeholder="Jenis dan Warna Kemasan" />
                                                                </div>
                                                            </div>
