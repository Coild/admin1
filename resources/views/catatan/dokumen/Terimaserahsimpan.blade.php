...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Penerimaan dan Pengeluaran Bahan Baku</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Penerimaan dan Pengeluaran Bahan Baku</li>
        </ol>
        <div class="row">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inputName" placeholder="Nomor Loth" maxlength="20"/>
                                        </div>
                                        <div class="form-group">
