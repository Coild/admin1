                                                ...
                                                <form role="form" id="forminput1" action="tambah_pelatihanhiginitas" method="post">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="kode_pelatihan" class="form-control 1" id="inputEmail3" placeholder="Kode Pelatihan" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Materi
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="materi_pelatihan" class="form-control 1" id="inputEmail3" placeholder="Materi Pelatihan" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Peserta
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="peserta_pelatihan" class="form-control 1" id="inputEmail3" placeholder="Peserta 1, Peserta 2,..." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm">
                                                            <input type="text" name="pelatih" class="form-control 1" id="inputEmail3" placeholder="Pelatih 1, Pelatih 2,..." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="metode_pelatihan" class="form-control 1" id="inputEmail3" placeholder="Metode Pelatihan" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm">
                                                                    <input type="datetime-local" name="mulai" class="form-control 1" id="inputEmail3" placeholder="xx/xx/xxxx" />
                                                                </div>
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Selesai</label>
                                                                <div class="col-sm">
                                                                    <input type="datetime-local" name="berakhir" class="form-control 1" id="inputEmail3" placeholder="xx/xx/xxxx" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                                            Penilaian</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="metode_penilaian" class="form-control 1" id="inputEmail3" placeholder="Metode Penilaian" />
                                                        </div>
                                                    </div>
                                                ...
                                                <form role="form" id="forminput2" action="tambah_pelatihancpkb" method="post">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="kode_pelatihan" class="form-control 2" id="inputEmail3" placeholder="Kode Pelatihan" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Materi
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="materi_pelatihan" class="form-control 2" id="inputEmail3" placeholder="Materi Pelatihan" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Peserta
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="peserta_pelatihan" class="form-control 2" id="inputEmail3" placeholder="Peserta 1, Peserta 2,..." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Pelatih</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="pelatih" class="form-control 2" id="inputEmail3" placeholder="Pelatih 1, Pelatih 2,..." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                                            Pelatihan</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="metode_pelatihan" class="form-control 2" id="inputEmail3" placeholder="Metode Pelatihan" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm">
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Mulai</label>
                                                                <div class="col-sm">
                                                                    <input type="datetime-local" name="mulai" class="form-control 2" id="inputEmail3" placeholder="xx/xx/xxxx" />
                                                                </div>
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Selesai</label>
                                                                <div class="col-sm">
                                                                    <input type="datetime-local" name="berakhir" class="form-control 2" id="inputEmail3" placeholder="xx/xx/xxxx" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                                            Penilaian</label>
                                                        <div class="col-sm">
                                                            <input type="text" name="metode_penilaian" class="form-control 2" id="inputEmail3" placeholder="Metode Penilaian" />
                                                        </div>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="terimapelatihancpkb">
                                                    @csrf
                                                    <input type="hidden" name="nobatch" value="{{ $row['kode_pelatihan'] }}" />
                                                    <button type="submit" class="btn btn-primary">terima kasih</button>
                                                </form>
                                                @else
                                                <form method="post" action="#">
                                                    @csrf
