                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="kode_pelatihan"
                                                                    class="form-control 1" placeholder="Kode Pelatihan"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="materi_pelatihan"
                                                                    class="form-control 1" placeholder="Materi Pelatihan" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="metode_pelatihan"
                                                                    class="form-control 1" placeholder="Metode Pelatihan" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="metode_penilaian"
                                                                    class="form-control 1" placeholder="Metode Penilaian" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        @if (Auth::user()->level == 2)
                                                            <form method="post" action="terimapelatihanhigisani">
                                                                ...
                                                                <input type="hidden" name="nobatch"
                                                                    value="{{ $row['kode_pelatihan'] }}" />
                                                                <button type="submit"
                                                                    class="btn btn-primary">terima</button>
                                                            </form>
                                                        @else
                                                            <button type="button" id="klikhigi" class="btn btn-primary"
                                                                data-toggle="modal" data-target="#edithigi"
                                                                data-kode="{{ $row['kode_pelatihan'] }}"
                                                                data-materi="{{ $row['materi_pelatihan'] }}"
                                                                data-peserta="{{ $row['peserta_pelatihan'] }}"
                                                                data-pelatih="{{ $row['pelatih'] }}"
                                                                data-metode="{{ $row['metode_pelatihan'] }}"
                                                                data-mulai="{{
                                                                $newDate = date('Y-m-d\TH:i', strtotime($row['jadwal_mulai_pelatihan']));
                                                                 }}"
                                                                data-selesai="{{
                                                                $newDate = date('Y-m-d\TH:i', strtotime($row['jadwal_berakhir_pelatihan']));  }}"
                                                                data-nilai="{{ $row['metode_penilaian'] }}"
                                                                data-id="{{ $row['id_programpelatihan'] }}">edit</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form role="form" id="forminput2" action="tambah_pelatihancpkb"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="kode_pelatihan"
                                                                    class="form-control 2" placeholder="Kode Pelatihan"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" name="materi_pelatihan"
                                                                    class="form-control 2" placeholder="Materi Pelatihan" />
                                                            </div>
                                                        </div>
                                            ...
                                            @foreach ($data1 as $row)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button type="button" id="klikcpkb" class="btn btn-primary"
                                                                data-toggle="modal" data-target="#editcpkb"
                                                                data-kode="{{ $row['kode_pelatihan'] }}"
                                                                data-materi="{{ $row['materi_pelatihan'] }}"
                                                                data-peserta="{{ $row['peserta_pelatihan'] }}"
                                                                data-pelatih="{{ $row['pelatih'] }}"
                                                                data-metode="{{ $row['metode_pelatihan'] }}"
                                                                data-mulai="{{ $newDate = date('Y-m-d\TH:i', strtotime($row['jadwal_mulai_pelatihan'])); }}"
                                                                data-selesai="{{ $newDate = date('Y-m-d\TH:i', strtotime($row['jadwal_berakhir_pelatihan'])); }}"
                                                                data-nilai="{{ $row['metode_penilaian'] }}"
                                                                data-id="{{ $row['id_pelatihancpkb'] }}">edit</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                        ...
                        <form role="form" id="forminput3" action="edit_pelatihanhiginitas" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="higi_kode" type="text" name="kode_pelatihan" class="form-control 3"
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Materi
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="higi_materi" type="text" name="materi_pelatihan" class="form-control 3"
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Peserta
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="higi_peserta" type="text" name="peserta_pelatihan" class="form-control 3"
                                        placeholder="Peserta 1, Peserta 2,..." />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input id="higi_pelatih" type="text" name="pelatih" class="form-control 3"
                                        placeholder="Pelatih 1, Pelatih 2,..." />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="higi_metode" type="text" name="metode_pelatihan" class="form-control 3"
                                        placeholder="Metode Pelatihan" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input id="higi_mulai" type="datetime-local" name="mulai"
                                                class="form-control 3" placeholder="xx/xx/xxxx" />
                                        </div>
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Selesai</label>
                                        <div class="col-sm">
                                            <input id="higi_selesai" type="datetime-local" name="berakhir"
                                                class="form-control 3" placeholder="xx/xx/xxxx" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                    Penilaian</label>
                                <div class="col-sm">
                                    <input id="higi_nilai" type="text" name="metode_penilaian" class="form-control 3"
                                        placeholder="Metode Penilaian" />
                                </div>
                            </div>
                        ...
                        <form role="form" id="forminput4" action="edit_pelatihancpkb" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="cpkb_kode" type="text" name="kode_pelatihan" class="form-control 4"
                                        placeholder="Kode Pelatihan" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Materi
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="cpkb_materi" type="text" name="materi_pelatihan" class="form-control 4"
                                        placeholder="Materi Pelatihan" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Peserta
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="cpkb_peserta" type="text" name="peserta_pelatihan" class="form-control 4"
                                        placeholder="Peserta 1, Peserta 2,..." />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Pelatih</label>
                                <div class="col-sm">
                                    <input id="cpkb_pelatih" type="text" name="pelatih" class="form-control 4"
                                        placeholder="Pelatih 1, Pelatih 2,..." />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                    Pelatihan</label>
                                <div class="col-sm">
                                    <input id="cpkb_metode" type="text" name="metode_pelatihan" class="form-control 4"
                                        placeholder="Metode Pelatihan" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Mulai</label>
                                        <div class="col-sm">
                                            <input id="cpkb_mulai" type="datetime-local" name="mulai"
                                                class="form-control 4" placeholder="xx/xx/xxxx" />
                                        </div>
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Selesai</label>
                                        <div class="col-sm">
                                            <input id="cpkb_selesai" type="datetime-local" name="berakhir"
                                                class="form-control 4" placeholder="xx/xx/xxxx" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Metode
                                    Penilaian</label>
                                <div class="col-sm">
                                    <input id="cpkb_nilai" type="text" name="metode_penilaian" class="form-control 4"
                                        placeholder="Metode Penilaian" />
                                </div>
                            </div>
