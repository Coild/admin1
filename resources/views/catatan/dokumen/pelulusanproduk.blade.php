                            ...
                            @foreach ($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button id="klik_lulus" class="btn btn-primary" data-toggle="modal" data-target="#editlulus"
                                                data-tanggal="{{ $row['tanggal'] }}"
                                                data-nama="{{ $row['nama_bahan'] }}"
                                                data-nobatch="{{ $row['no_batch'] }}"
                                                data-kadaluarsa="{{ $newDate = date('Y-m-d\TH:i', strtotime($row['kedaluwarsa'])); }}"
                                                data-pemasok="{{ $row['nama_pemasok'] }}"
                                                data-warna="{{ $row['warna'] }}" data-bau="{{ $row['bau'] }}"
                                                data-ph="{{ $row['ph'] }}"
                                                data-berat="{{ $row['berat_jenis'] }}"
                                                data-id="{{ $row['id_pelulusan'] }}">Edit</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">No
                                        Batch</label>
                                    <div class="col-sm">
                                        <input type="text" name="nobatch" class="form-control 2" id="nobatch"
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                        Pemasok</label>
                                    <div class="col-sm">
                                        <input type="text" name="nama_pemasok" class="form-control 2" id="pemasok"
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" name="warna" class="form-control 2" id="warna"
                                                placeholder="Warna" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input type="bau" name="bau" class="form-control 2" id="bau"
                                                placeholder="Bau" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Berat
                                            Jenis</label>
                                        <div class="col-sm">
                                            <input type="text" name="berat_jenis" class="form-control 2" id="berat"
