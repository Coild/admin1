                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                                                Produk</label>
                                                            <div class="col-sm">
                                                                <input class="form-control" list="listnamaproduk"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            data-id="{{ $row['id_pengemasanbatchproduk'] }}">edit</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input class="form-control 1" list="listnamaproduk"
                                        type="text" name='nama_produk' id="editnamaproduk">
                                    </input>
                                    <datalist id='listnamaproduk'>
                                        @foreach ($produk as $row)
                                            <option value="{{ $row['produk_nama'] }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="text" name="kode_produk" readonly
                                        class="form-control 1" id="editkodeproduk"
                                        placeholder="Kode Produk" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Besar
                                    Batch</label>
                                <div class="col-sm">
                                    <input type="text" name="besar_batch" class="form-control 1"
                                        id="isi_besar" placeholder="Besar Batch" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Bentuk
                                ...
                                <div class="col-sm">
                                    <input type="text" name="bentuk_sediaan"
                                        class="form-control 1" id="isi_bentuk"
                                        placeholder="Bentuk Sediaan" />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="text" list="kemasan" style="height: 35px;"
                                        name="kemasan" class="form-control 1"
                                        id="isi_kemasan">
                                    </input>
                                    <datalist id="kemasan">
                                        @foreach ($kemasan as $row)
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="datetime-local" name="mulai"
                                        class="form-control 1" id="isi_mulai"
                                        placeholder="Tipe/Merek" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="datetime-local" name="selesai"
                                        class="form-control 1" id="isi_selesai"
                                        placeholder="Tipe/Merek" />
                                </div>
                            </div>
