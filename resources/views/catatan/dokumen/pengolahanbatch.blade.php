                            ...
                            @foreach ($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-success" id="klikbatch" data-toggle="modal"
                                            data-target="#editbatch" data-kode="{{ $row['kode_produk'] }}"
                                            data-nama="{{ $row['nama_produk'] }}"
                                            data-nobatch="{{ $row['nomor_batch'] }}"
                                            data-besar="{{ $row['besar_batch'] }}"
                                            data-bentuk="{{ $row['bentuk_sedia'] }}"
                                            data-kategori="{{ $row['kategori'] }}"
                                            data-kemasan="{{ $row['kemasan'] }}" data-protap="{{ $row['pob'] }}"
                                            data-id="{{ $row['batch'] }}">Edit</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm">
                                                        <input type="text" name="pob" class="form-control"
                                                            id="inputEmail3" placeholder="Nomor PROTAP" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Bentuk
                                                        Sediaan</label>
                                                    <div class="col-sm">
                                                        <input placeholder="Bentuk Sediaan" class="form-control"
                                                            name="bentuk sediaan" type="text" />
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Sesuai
                                            Dengan PROTAP No</label>
                                        <div class="col-sm">
                                            <input type="text" name="pob" class="form-control 1" id="isi_protap"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input class="form-control 1" list="listnamaproduk" type="text"
                                                name='nama_produk' id="editnamaproduk">
                                            </input>
                                            <datalist id='listnamaproduk'>
                                                @foreach ($data2 as $row)
                                                    <option value="{{ $row['produk_nama'] }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kode
                                            Produk</label>
                                        <div class="col-sm">
                                            <input type="text" name="kode_produk" readonly class="form-control 1"
                                                id="editkodeproduk" placeholder="Kode Produk" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Nomor
                                            Batch</label>
                                        <div class="col-sm">
                                            <input type="text" name="no_batch" class="form-control 1" id="isi_nobatch"
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Besar
                                            Batch</label>
                                        <div class="col-sm">
                                            <input type="text" name="besar_batch" class="form-control 1" id="isi_besar"
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Bentuk
                                            Sediaan</label>
                                        <div class="col-sm">
                                            <input placeholder="Bentuk Sediaan" class="form-control 1" name="bentuk sediaan"
                                                id="isi_bentuk" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input placeholder="Kategori" class="form-control 1" name="kategori"
                                                id="isi_kategori" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" list="kemasan" style="height: 35px;" name="kemasan"
                                                class="form-control 1" id="isi_kemasan">
                                            </input>
                                            <datalist id="kemasan">
                                                @foreach ($data3 as $row)
                                                    <option value="{{ $row['kemasan_nama'] }}">
