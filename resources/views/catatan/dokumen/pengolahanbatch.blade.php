                            ...
                            <td>
                                ...
                                @else
                                    ...
                                    <form action="/pjt_pengolahanbatch" method="post" id="terimalaporan{{ $row['batch'] }}">
                                            ...
                                            <input type="hidden" name="no" value="{{ $row['batch'] }}">
                                            <button onclick="TerimaLaporan({{ $row['batch'] }})" type="button" class="btn btn-primary">
                                                Terima
                                            </button>
                                        </form>
                                    @else
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nomor
                                                    Batch</label>
                                                <div class="col-sm">
                                                    <input type="text" name="no_batch" class="form-control 17" id="inputEmail3" placeholder="Nomor Batch" maxlength="20"/>
                                                </div>
                                                <p class="text-danger"></p>
                                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nomor
                                        Batch</label>
                                    <div class="col-sm">
                                        <input type="text" name="no_batch" class="form-control 1" id="isi_nobatch" placeholder="Nomor Batch" maxlength="20"/>
                                    </div>
                                </div>
