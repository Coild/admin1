                                                    ...
                                                    <div class="card mb-4">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <form role="form" method="post"
                                                                action="tambah_pemusnahanbahan" id='forminput1'>
                                                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    @if (Auth::user()->level != 2)
                                        <button class="btn btn-success btn-lg" data-toggle="modal"
                                            data-target="#modalForm2" onclick="setdatetoday1(2)">
                                                    ...
                                                    @else
                                                        <td>
                                                            ...
                                                            <form method="post" action="terimapemusnahanbahankemas"
                                                                id="formTerimaLaporan2{{ $row['id_pemusnahanbahankemas'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_pemusnahanbahankemas'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan2({{ $row['id_pemusnahanbahankemas'] }})"
                                                                    class="btn btn-primary">Terima</button>
                                                            </form>
                                                            <?php } elseif ($row['status'] == 1) { ?>
                                                            <form method="post" action="terimapemusnahanbahan">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <p class="statusMsg"></p>
                                                                <form role="form" method="post"
                                                                    action="tambah_pemusnahanprodukantara"
                                                                    id='forminput3'>
                                                                    @csrf
                                                                    <input type="hidden" name="_token"
                                                                        value="{{ csrf_token() }}" />
                                                        ...
                                                        @else
                                                            <td>
                                                                ...
                                                                <form method="post" action="terimapemusnahanprodukantara"
                                                                    id="formTerimaLaporan3{{ $row['id_pemusnahanprodukantara'] }}">
                                                                    @csrf
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $row['id_pemusnahanprodukantara'] }}" />
                                                                    <button type="button"
                                                                        onclick="buttonTerimaLaporan3({{ $row['id_pemusnahanprodukantara'] }})"
                                                                        class="btn btn-primary">Terima</button>
                                                                </form>
                                                        ...
                                                        @else
                                                            <td>
                                                                ...
                                                                <form method="post" action="terimapemusnahanprodukjadi"
                                                                    id="formTerimaLaporan4{{ $row['id_pemusnahanprodukjadi'] }}">
                                                                    @csrf
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $row['id_pemusnahanprodukjadi'] }}" />
                                                                    <button type="button"
                                                                        onclick="buttonTerimaLaporan4({{ $row['id_pemusnahanprodukjadi'] }})"
                                                                        class="btn btn-primary">Terima</button>
                                                                </form>
