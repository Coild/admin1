...
<main>
                                                        ...
                                                        <form role="form" method="post" action="tambah_pemusnahanbahan" id='forminput1'>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm">
                                                                        <select style="height: 35px;" class="form-control" name="protap_induk" id="protap_indukbb">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['status'] == 0) { ?>
                                                    ...
                                                    <form method="post" action="terimapemusnahanbahan" id="formTerimaLaporan{{ $row['id_pemusnahanbahan'] }}">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{ $row['id_pemusnahanbahan'] }}" />
                                                        <button type="button" onclick="buttonTerimaLaporan({{ $row['id_pemusnahanbahan'] }})" class="btn btn-primary">Terima</button>
                                                    </form>
                                                <?php } elseif ($row['status'] == 1) { ?>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form role="form" method="post" action="tambah_pemusnahanbahankemas" id='forminput2'>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Protap</label>
                                                                <div class="col-sm">
                                                                    <select style="height: 35px;" class="form-control" name="protap_induk" id="protap_indukbk">
                                ...
                                <table class="table mt-5" id="tabel2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['status'] == 0) { ?>
                                                    <form method="post" action="terimapemusnahanbahankemas" id="formTerimaLaporan2{{ $row['id_pemusnahanbahankemas'] }}">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{ $row['id_pemusnahanbahankemas'] }}" />
                                                        <button type="button" onclick="buttonTerimaLaporan2({{ $row['id_pemusnahanbahankemas'] }})" class="btn btn-primary">Terima</button>
                                                    </form>
                                                <?php } elseif ($row['status'] == 1) { ?>
                                                    <form method="post" action="terimapemusnahanbahan">
                                                        @csrf
                                                            ...
                                                            <form role="form" method="post" action="tambah_pemusnahanprodukantara" id='forminput3'>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group row">
                                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Protap</label>
                                                                        <div class="col-sm">
                                                                            <select style="height: 35px;" class="form-control" name="protap_induk" id="protap_indukpa">
                                                                                @foreach ($data_protappa as $row)
                                                                                <option value="{{ $row['protap_id'] }}">
                                                                                    {{ $row['protap_nama'] }}
                                                                                </option>
                                                                                @endforeach
                                    ...
                                    <table class="table mt-5" id="tabel3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row['status'] == 0) { ?>
                                                        <form method="post" action="terimapemusnahanprodukantara" id="formTerimaLaporan3{{ $row['id_pemusnahanprodukantara'] }}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{ $row['id_pemusnahanprodukantara'] }}" />
                                                            <button type="button" onclick="buttonTerimaLaporan3({{ $row['id_pemusnahanprodukantara'] }})" class="btn btn-primary">Terima</button>
                                                        </form>
                                                            ...
                                                            <form role="form" method="post" action="tambah_pemusnahanprodukjadi" id='forminput4'>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group row">
                                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Protap</label>
                                                                        <div class="col-sm">
                                                                            <select style="height: 35px;" class="form-control" name="protap_induk" id="protap_indukpj">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row['status'] == 0) { ?>
                                                        ...
                                                        <form method="post" action="terimapemusnahanprodukjadi" id="formTerimaLaporan4{{ $row['id_pemusnahanprodukjadi'] }}">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{ $row['id_pemusnahanprodukjadi'] }}" />
                                                            <button type="button" onclick="buttonTerimaLaporan4({{ $row['id_pemusnahanprodukjadi'] }})" class="btn btn-primary">Terima</button>
                                                        </form>
    ...
    <script>
        ...
        function editdata3(params) {
            ...
            $("#protap_indukpa").val(params.protap)
