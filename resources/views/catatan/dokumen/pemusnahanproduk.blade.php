                                                ...
                                                <tr>
                                                    ...
                                                    @if (Auth::user()->level != 2)
                                                        <td>
                                                            ...
                                                            <a href="#" type="submit" data-toggle="modal"
                                                                data-target="#modalForm1" class="btn btn-danger disabled"
                                                                onclick="editdata1({{ $row }})">Edit</a>
                                                            <?php } ?>
                                                    ...
                                                    @else
                                                        <td>
                                                            ...
                                                            <form method="post" action="terimapemusnahanbahan"
                                                                id="formTerimaLaporan{{ $row['id_pemusnahanbahan'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_pemusnahanbahan'] }}" />
                                                                <button type="button"
                                                                    onclick="buttonTerimaLaporan({{ $row['id_pemusnahanbahan'] }})"
                                                    ...
                                                    @else
                                                        <td>
                                                            ...
                                                            <form method="post" action="terimapemusnahanbahankemas" id="formTerimaLaporan2{{ $row['id_pemusnahanbahankemas'] }}">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $row['id_pemusnahanbahankemas'] }}" />
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm">
                                                                                <select style="height: 35px;"
                                                                                    class="form-control"
                                                                                    name="protap_induk" id="protap_indukpa">
                                                        ...
                                                        @else
                                                            <td>
                                                                ...
                                                                <form method="post" action="terimapemusnahanprodukantara" id="formTerimaLaporan3{{ $row['id_pemusnahanprodukantara'] }}">
                                                                    @csrf
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $row['id_pemusnahanprodukantara'] }}" />
