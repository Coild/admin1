                                    ...
                                    <td>
                                        @if (Auth::user()->level == 2)
                                            ...
                                            <form method="post" action="terimadistribusiproduk"
                                                id="terimalaporan{{ $row['id_distribusi'] }}">
                                                @csrf
                                                <input type="hidden" name="nobatch"
                                                    value="{{ $row['id_distribusi'] }}" />
                                                <button type="button"
                                                    onclick="TerimaLaporan({{ $row['id_distribusi'] }})"
                                        ...
                                        @else
                                            <?php if ($row['status'] == 0) { ?>
                                            <button id="klikdis" type="submit" class="btn btn-primary"
                                                data-toggle="modal" data-target="#edit_distribusi"
                                                data-protap="{{ $row['protap_id'] }}"
                                                data-kode="{{ $row['kode_distribusi'] }}"
                                                data-nobatch="{{ $row['id_batch'] }}"
                                                data-jumlah="{{ preg_replace('/[^0-9]/', '', $row['jumlah']) }}"
                                                data-satuan="{{ preg_replace('/[^a-zA-Z]+/', '', $row['jumlah']) }}"
                                                data-nama="{{ $row['nama_distributor'] }}"
                                                data-id="{{ $row['id_distribusi'] }}">edit</button>
                                            <?php } elseif ($row['status'] == 1) { ?>
                                            <button id="klikdis" type="submit" class="btn btn-danger disabled"
                                                data-toggle="modal" data-target="#edit_distribusi"
                                                data-kode="{{ $row['kode_distribusi'] }}"
                                                data-nobatch="{{ $row['id_batch'] }}" data-jumlah="{{ $row['jumlah'] }}"
                                                data-nama="{{ $row['nama_distributor'] }}"
                                                data-id="{{ $row['id_distribusi'] }}">edit</button>
                                            <?php } ?>
                                        @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" name="no_batch" class="form-control 1"
                                                id="isi_nobatch" placeholder="No Batch" maxlength="20"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Nama
                                            Distributor</label>
                                        <div class="col-sm">
                                            <input type="text" name="nama_distributor" class="form-control 1"
                                                id="isi_nama" placeholder="Nama Distributor" />
                                        </div>
                                    </div>
